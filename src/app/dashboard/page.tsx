...
export default function Dashboard() {
  ...
  const funnelData = [
    ...
    { name: 'Interview', value: applications.filter(app => ['PHONE_SCREEN', 'INTERVIEW', 'OFFER', 'TECHNICAL_INTERVIEW', 'HR_INTERVIEW', 'INTERVIEW_SCHEDULED'].includes(app.status)).length, fill: 'hsl(var(--chart-3))' },
